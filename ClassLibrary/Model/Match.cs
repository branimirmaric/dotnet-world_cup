...
namespace ClassLibrary.Model
{
    ...
    public partial class Match
    {
        ...
        {
            int result = HomeTeamEvents
                .Concat(AwayTeamEvents)
                .Count(ev => ev.Player == player && (ev.TypeOfEvent == "goal" || ev.TypeOfEvent == "goal-penalty"));
        ...
        public int GetYellowCardsByPlayer(string player) // +
        {
            int result = HomeTeamEvents
                .Concat(AwayTeamEvents)
                .Count(ev => ev.Player == player && ev.TypeOfEvent == "yellow-card");
    ...
    {
        public static string ToJson(this List<Match> self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
